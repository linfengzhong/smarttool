...
function inital_smart_tool() {
    ...
    array_service_description=("CPU" "Disk" "Memory" "SSH" "Service xray" "Service nginx" "Service ncpa" "HTTP" "SSL" )
    array_check_command=("check_ncpa_cpu" "check_ncpa_disk" "check_ncpa_memory" "check_ssh" "check_ncpa_service_xray" "check_ncpa_service_nginx" "check_ncpa_service_ncpa_listener" "check_http" "check_certificate_expires" )
